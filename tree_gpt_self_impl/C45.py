            ...
            for i in range(len(features)):
                ...
                for j in v:
                    ...
                    if dv_nums == 0 or d_nums == 0:
                        continue
                    Ga -= dv_nums / d_nums * ent_dv # 信息增益
                    IV -= dv_nums/d_nums*np.log2(dv_nums/d_nums) # 分离信息

                if IV != 0.0 and (Ga/IV) > max_gain_ratio:
                    max_gain_ratio = Ga/IV # 信息增益比
                    feature = features[i]
