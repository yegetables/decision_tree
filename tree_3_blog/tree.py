...
def createPlot(inTree,filename):
    ...
    fig.savefig(os.path.join(current_work_dir, str(filename+".png")))

dataSet, labels = createDataSet()
treeid3 = createTreeUsingID3(dataSet, labels)  # 通过ID3算法建树
createPlot(treeid3, "tree-id3")
# treec45 = createTreeUsingC4Dot5(dataSet, labels)  # 通过C4.5算法建树
# createPlot(treec45, "tree-c45")
# print(tree)
